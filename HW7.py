...
#     count = 0
#     for c in s:
#         if c in ["а", "e", "ё", "и", "о", "у", "ы", "э", "ю", "я"]:
#             count += 1
#     return count

# def check_rithm(phrasi):
#     num_glasnie = count_glasnie(phrasi[0])
#     for i in range(1, len(phrasi)):
#         if count_glasnie(phrasi[i]) != num_glasnie:
#             return False
#     return True
# phrasi = "пара-ра-рам рам-пам-папам па-ра-па-да".split()
# is_rithm = check_rithm(phrasi)
# if is_rithm:
#     print("Парам пам-пам")
# else:
#     print("Пам парам")
